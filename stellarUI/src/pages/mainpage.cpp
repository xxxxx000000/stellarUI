...
MainPage::MainPage() {
    ...
    btn3->onClickCallback = [this](){
       uiManager.pushPage(new ToolsPage(),TransitionType::SlideDown);
    };
    addChild(btn3);
    auto* txt = new Text(150,75,"lock",2,TFT_BLACK,true);
    addChild(txt);
    auto* txt2 = new Text(150,145,"imu",2,TFT_BLACK,true);
    addChild(txt2);
    auto* txt3 = new Text(150,215,"more",2,TFT_BLACK,true);
    addChild(txt3);
